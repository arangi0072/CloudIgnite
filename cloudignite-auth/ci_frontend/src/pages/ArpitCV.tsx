        ...
        <div className={`lg:col-span-2 space-y-8 ${isCustomPiP ? 'fixed bottom-6 right-6 w-80 z-[100] shadow-2xl' : ''}`}>
          ...
          <div className="relative group/player">
            ...
            <motion.div
              ...
              className={`relative rounded-2xl overflow-hidden bg-black border border-white/10 group transition-all duration-700 z-10 ${isFullscreen ? 'rounded-none border-none' : ''
              ...
              {chapters.map((chapter, index) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left p-4 rounded-xl border transition-all duration-300 group relative overflow-hidden ${isCurrent
