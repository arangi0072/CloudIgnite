...
import { ArrowLeft, Mail, Lock, Terminal, Zap, Globe, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-surface flex relative overflow-hidden selection:bg-primary selection:text-surface">
      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden border-r border-white/5 bg-surface-container-lowest">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--color-primary)_0%,transparent_50%)] opacity-10 pointer-events-none"></div>
        ...
        <div className="relative z-10 w-full max-w-lg p-12">
          ...
          >
            <h2 className="text-5xl font-black text-white mb-6 leading-[1.1]">
              Welcome back to <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-br from-primary to-secondary">the edge.</span>
            </h2>
            <p className="text-lg text-on-surface-variant mb-12">
              Log in to manage your global deployments, monitor real-time analytics, and scale your infrastructure.
            </p>
          ...
          >
            <div className="text-center lg:text-left mb-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-500">Secure Connection</span>
              </div>
              <h1 className="text-3xl lg:text-4xl font-black text-white mb-3 tracking-tight">Sign in</h1>
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2 group">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-[11px] font-bold text-primary hover:text-primary-dim transition-colors">Forgot password?</a>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="flex items-center gap-3 pt-2">
                <div className="relative flex items-center justify-center">
                  <input type="checkbox" id="remember" className="peer appearance-none w-4 h-4 border border-white/20 rounded bg-surface-container-low checked:bg-primary checked:border-primary transition-colors cursor-pointer" />
                ...
                <label htmlFor="remember" className="text-xs text-on-surface-variant hover:text-white transition-colors cursor-pointer select-none">Remember me for 30 days</label>
              </div>
            ...
            <div className="mt-8 text-center lg:text-left">
              <p className="text-sm text-on-surface-variant">
                ...
                <Link to="/signup" className="font-bold text-white hover:text-primary transition-colors">Sign up</Link>
              </p>
            </div>
          </motion.div>
        </main>
