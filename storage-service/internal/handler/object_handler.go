...
func (h *ObjectHandler) GeneratePreviewURL(c *gin.Context) {
	...
	url, err := h.Service.GeneratePreviewURL(
		projectID,
		bucket,
		key,
	)
...
func (h *ObjectHandler) GenerateDownloadURL(c *gin.Context) {
...
func (h *ObjectHandler) Download(c *gin.Context) {
	...
	obj, meta, err := h.Service.DownloadStream(
		projectID,
		bucket,
		key,
	)
